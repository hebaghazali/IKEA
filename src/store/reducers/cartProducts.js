    ...
    case 'SET-AMOUNT':
      {
        ...
        state.cartProducts.find((i,index)=>{
            ...
            {
              state.cartProducts[index].PurchasedAmount=action.payload.PurchasedAmount;
            }
            state.totalPrice+=state.cartProducts[index].PurchasedAmount*state.cartProducts[index].productData.Price;
            state.totalAmountOfCartItems+=state.cartProducts[index].PurchasedAmount;
        })
        return{
          ...state,
